...
<body>
    <form id="form1" name="form1" method="post" action="perfil.php">
        ...
        <input type="text" name="Nome" id="Nome" value="<?php echo $_SESSION['PerfilData']['Nome'];?>"/>
        </div>
        <br class="clear" /> 
...
//                echo '<p>' . $valores['nome'] . '</p>';
                ...
                if ($valores['id'] === $_SESSION['PerfilData']['Distritoid'])        
                        echo ' selected';
                    echo '>' . $valores['distrito'] .'</option>';
            }
            ?>
        </select>
        <br class="clear" /> 
        
        <label for="Nome">Cidade: *</label><input type="text" value="<?php echo $_SESSION['PerfilData']['Cidade'];?>" name="Cidade" id="Cidade"/>
        <br class="clear" /> 
        ...
        <label for="Habilitações">Habilitações: 
        </label><input type="text" name="Habilitacoes" value="<?php echo $_SESSION['PerfilData']['Habilitacoes'];?>" id="Habilitações" />
        <br class="clear" /> 
        
        <label for="Nome">Profissao:</label>
        <input type="text" name="Profissao" value="<?php echo $_SESSION['PerfilData']['Profissao'];?>" id="Profissao"/>
        <br class="clear" /> 
        ...
        <input type="text" name="Descricao" value="<?php echo $_SESSION['PerfilData']['Descricao'];?>" id="Descrição" />
        <br class="clear" /> 
        ...
        <input type="text" name="Altura" class="l-small" value="<?php echo $_SESSION['PerfilData']['Altura'];?>" id="Altura" />
        <br class="clear" /> 
        
        <label for="Peso">Peso: </label>
        <input type="text" name="Peso" class="l-small" value="<?php echo $_SESSION['PerfilData']['Peso'];?>" id="Peso" />
        <br class="clear" /> 
        
        <label for="CamposObr" style="color: tomato">* Campos Obrigatorios</label>
        <br class="clear" /> 
